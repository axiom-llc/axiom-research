...
**Evidence class:** `VALIDATED_EXECUTABLE_DEMO` — synthetic local-file execution, not a production deployment.

This case study records a reproducible synthetic organizational workflow executed through the canonical Research → ASON → APEX path. The retained run models **15 organizational steps** and records **15 successful APEX effects/events**.

## What was validated

- exact APEX completion and terminal-state equality;
- durable authorization and approved-plan binding;
- effect-ledger and authorization evidence;
- missing authority blocked dispatch before APEX run creation;
- live recovery reused completed local-file effects without rewriting produced files.

## Evidence

- [Scenario](../software-development/scenarios/end-to-end.json)
- [Retained evidence](../software-development/evidence/accepted-20260916/evidence.json)
- [Evaluation](../software-development/evidence/accepted-20260916/evaluation.json)
- [Domain findings](../software-development/findings.md)
